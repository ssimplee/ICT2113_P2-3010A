...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=5cm]{image2}\hspace{2pt}%
  \includegraphics[height=5cm]{image3}\hspace{2pt}%
  \includegraphics[height=5cm]{image4}\hspace{2pt}%
  \includegraphics[height=5cm]{image5}\hspace{2pt}%
  \includegraphics[height=5cm]{image6}\hspace{2pt}%
  \includegraphics[height=5cm]{image7}\hspace{2pt}%
  \includegraphics[height=5cm]{image8}\\[4pt]
  \includegraphics[height=5cm]{image9}\hspace{2pt}%
  \includegraphics[height=5cm]{image10}
